...
urlpatterns = [
    ...
    path('masterfile/students/update/final/<int:pk>/', views.masterfilestudentsupdatefinal, name='masterfilestudentsupdatefinal'),
    ...
    path('masterfile/table-of-specification/<int:pk>', views.table_of_secificationcreate, name='table_of_secificationcreate'),
    path('masterfile/table-of-specification/<int:group_id>', views.table_of_secificationupdate, name='table_of_secificationupdate'),
    ...
    path('masterfile/students/display-scores-and-rank/tos/<int:exam_id>', views.display_scores_tos, name='display_scores_tos'),
